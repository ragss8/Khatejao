...
import MenuInfo from './MenuRedux/MenuInfo';
  ...
  const handleAddItem = () => {
    ...
    axios
      ...
      .then((response) => {
        ...
        setPrice('');
        setIngredients('');
        // After adding a new item, fetch updated menu details
    ...
    <div>
      ...
      <div className="container">
        ...
        <div className="menu-container">
          ...
          {/* Pass restaurantId as a prop to MainMenu component */}
...
// Define the MainMenu component here
        ...
        <form>
          <label className="restaurant-label">
            ...
            <input
              ...
              type="text"
              value={restaurant_id}
              readOnly // Set the input field as read-only since it's managed by the Menu component
              required
            />
          </label>
        </form>
