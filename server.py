...
#     user = user_collection.find_one({"email": form.email, "password": form.password})

#     if user:
#         return {"message": "Login successful"}
#     else:
#         raise HTTPException(status_code=404, detail="Invalid email or password. Please sign up or retry.")
